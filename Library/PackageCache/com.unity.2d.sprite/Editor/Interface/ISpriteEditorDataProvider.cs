...
namespace UnityEditor.U2D.Sprites
{
    ...
    /// <summary>
    /// Data Provider interface that deals with custom Sprite data.
    /// </summary>
    internal interface ISpriteCustomDataProvider
    {
        /// <summary>
        /// Sets the custom data for a Sprite.
        /// </summary>
        /// <param name="guid">Sprite Guid.</param>
        /// <param name="newData">Data value.</param>
        public void SetData(GUID guid, string newData);
        
        /// <summary>
        /// Gets the custom data for a Sprite. 
        /// </summary>
        /// <param name="guid">Sprite Guid.</param>
        /// <returns>Data associated with a Sprite.</returns>
